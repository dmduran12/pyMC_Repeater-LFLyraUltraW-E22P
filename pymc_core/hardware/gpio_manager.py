...
# Use our custom wrapper instead of gpiozero
from .gpio_wrapper import Button, DigitalOutputDevice as OutputDevice

# Force Device.pin_factory to something if needed, or remove it
# We don't use gpiozero directly anymore
