...
# Use custom GPIO wrapper
from pymc_core.hardware.gpio_wrapper import DigitalInputDevice, DigitalOutputDevice
# Dummy Device class to avoid errors if referenced
class Device:
    pin_factory = None
...
class SX126x(BaseLoRa):
    ...
    def _writeBytes(self, opCode: int, data: tuple, nBytes: int):
        ...
        # Rely on spidev xfer2 to handle CS (hardware or software)
        spi.xfer2(buf)
